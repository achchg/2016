...
```{r}
#theta is the expected value of Y:
B = 100000
theta = -1/19
...
```{r}
# expected value of epsilon
0

# sd of epsilon: sqrt(theta*(1-theta)/N) by CLT
sqrt(0.534*(1-0.534)/100) 
# sd of epsilon empirical from our data:
sd(tab$estimate/100)
...
$\varepsilon$? 
```{r}
# expected value of epsilon ~ Normal(0,variance)
0

# sd of epsilon: sqrt(theta*(1-theta)/N) by CLT (theta is a proportion here)
